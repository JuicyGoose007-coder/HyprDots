...
# Hour (left-of-center, above)
label {
    monitor =
    text = cmd[update:1000] date +"%I"
    color = rgba(${FG1_R}, ${FG1_G}, ${FG1_B}, 0.92)
    font_size = 200
...
# Minute (right-of-center, slightly below)
label {
    monitor =
...
label {
    ...
    color = rgba(${FG0_R}, ${FG0_G}, ${FG0_B}, 0.65)
    font_size = 25
...
input-field {
    ...
    font_color = rgba(${FG1_R}, ${FG1_G}, ${FG1_B}, 0.9)
    fade_on_empty = true
